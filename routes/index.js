...
router.post( '/itemcount/create', item_count_controller.itemCount_create_post );
...
router.post( '/itemcount/:id/delete', item_count_controller.itemCount_delete_post );

router.get( '/itemcount/:id/update', item_count_controller.itemCount_update_get );
router.post( '/itemcount/:id/update', item_count_controller.itemCount_update_post );
